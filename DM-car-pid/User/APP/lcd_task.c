...
void lcd_task(void)
{
	  ...
	  // 传感器数据显示
		...
		LCD_ShowFloatNum(70, 40,INS.Pitch, 4, 2, WHITE, BLACK, 16);
		LCD_ShowString(130, 40,(uint8_t *)", ", BRRED, BLACK, 16, 0);
		LCD_ShowFloatNum(146, 40,chassis_move.myPithR, 4, 2, WHITE, BLACK, 16);

		LCD_ShowString(10, 56,(uint8_t *)"Yaw: ", BRRED, BLACK, 16, 0);		
		LCD_ShowFloatNum(70, 56,chassis_move.total_yaw, 4, 2, WHITE, BLACK, 16);
		LCD_ShowString(130, 56,(uint8_t *)", ", BRRED, BLACK, 16, 0);
		LCD_ShowFloatNum(146, 56,INS.Gyro[2], 4, 2, WHITE, BLACK, 16);
		
		LCD_ShowString(10, 88,(uint8_t *)"v_set: ", BRRED, BLACK, 16, 0);		
		LCD_ShowFloatNum(140, 88, chassis_move.v_set, 6, 3, WHITE, BLACK, 16);
		
		LCD_ShowString(10, 104,(uint8_t *)"turn_set: ", BRRED, BLACK, 16, 0);		
		LCD_ShowFloatNum(140, 104, chassis_move.turn_set, 6, 3, WHITE, BLACK, 16);

		LCD_ShowString(10, 136,(uint8_t *)"PID_flag: ", BRRED, BLACK, 16, 0);		
		LCD_ShowIntNum(140, 136, PID_flag, 3, WHITE, BLACK, 16);
		
		LCD_ShowString(10, 152,(uint8_t *)"vel_ratio: ", BRRED, BLACK, 16, 0);		
		LCD_ShowFloatNum(140, 152, vel_ratio, 6, 3, WHITE, BLACK, 16);		
		
//		LCD_ShowString(10, 168,(uint8_t *)"P_flag: ", BRRED, BLACK, 16, 0);		
//		LCD_ShowFloatNum(140, 168, P_flag, 6, 3, WHITE, BLACK, 16);
//		
//		LCD_ShowString(10, 184,(uint8_t *)"I_flag: ", BRRED, BLACK, 16, 0);		
//		LCD_ShowFloatNum(140, 184, I_flag, 6, 3, WHITE, BLACK, 16);	
//		
//		LCD_ShowString(10, 200,(uint8_t *)"D_flag: ", BRRED, BLACK, 16, 0);		
//		LCD_ShowFloatNum(140, 200, D_flag, 6, 3, WHITE, BLACK, 16);
//		
//		LCD_ShowString(40, 216,(uint8_t *)"out_ang: ", BRRED, BLACK, 16, 0);		
//		LCD_ShowFloatNum(120, 216, out_ang, 6, 3, WHITE, BLACK, 16);
//		
//		LCD_ShowString(40, 232,(uint8_t *)"out_vel: ", BRRED, BLACK, 16, 0);		
//		LCD_ShowFloatNum(120, 232, out_vel, 6, 3, WHITE, BLACK, 16);
//		LCD_ShowString(40, 248,(uint8_t *)"out_x: ", BRRED, BLACK, 16, 0);		
//		LCD_ShowFloatNum(120, 248, out_x, 6, 3, WHITE, BLACK, 16);
//	
